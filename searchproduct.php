...
class SearchProfile{
    ...
    public function dataProfiles($data = array())
	{
         ...
         $sql = "SELECT pid, name, sex, edob, caste, height, specialcase, religion, mothertonque, maritalstatus, smoking, drinking, habits, complexion, bodytype, qualification, employedin, occupation, annualincome, countrypresidence, state,, district, city, fathername, fathereducation, fatherprofession, mothername, mothereducation, motherprofession, fathernative, mothernative, brothers, sisters)
    VALUES('$pid', '$name', '$sex', '$edob', '$caste', '$height', '$specialcase', '$religion', '$mothertonque', '$maritalstatus', '$smoking', '$drinking', '$habits', '$complexion',
	'$bodytype', '$qualification', '$employedin', '$occupation', '$annualincome', '$countrypresidence', '$state', '$district', '$city', '$fathername',
	 '$fathereducation', '$fatherprofession', '$mothername', '$mothereducation', '$motherprofession','$fathernative', '$mothernative', '$brothers', '$sisters' FROM profile ORDER BY gender, state, mothertongue, maritialstatus FROM " .DB_PREFIX. "profile ";
